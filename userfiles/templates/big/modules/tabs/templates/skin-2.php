            ...
            <div class=" edit safe-mode" field="tab-item-<?php print $edit_field_key ?>"
                ...
                <div class="row border-bottom safe-mode cloneable element pb-5 mb-5">
                    <div class="col-lg-4 col-12">
                        <img src="<?php print template_url(); ?>assets/img/layouts/gallery-1-6.jpg" class="schedule-image img-fluid" alt="">
                    </div>
                    ...
                    <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                        ...
                        <div class="d-flex align-items-center mt-4">
                            <div class="avatar-group d-flex">
                                <img loading="lazy" class="avatar-image" src="<?php print template_url(); ?>modules/teamcard/templates/1.jpg">
