...
<<<<<<< Updated upstream
                    <img loading="lazy" src="<?php print template_url(); ?>assets/img/layouts/coffee.jpg"/>
=======
                   <img class="allow-select" loading="lazy" src="<?php print template_url(); ?>assets/img/layouts/coffee.jpg"/>
>>>>>>> Stashed changes
                </div>
            </div>
