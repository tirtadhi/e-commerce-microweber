...
<section class="<?php print $layout_classes; ?> section mw-new-layouts-1">
    <module type="background" id="background-layout--<?php print $params['id'] ?>" />
    <module type="spacer" id="spacer-layout--<?php print $params['id'] ?>-top" />

    <div class="container mw-layout-container no-element   text-center edit safe-mode" field="layout-new-layouts-skin-1-<?php print $params['id'] ?>" rel="module">
       <div class="mb-5">
           <h2 class="mw-new-7-heading-one" data-mwplaceholder="<?php _e('Enter title here'); ?>">All-in-one legal</h2>
           <h2 class="mw-new-7-heading-one" data-mwplaceholder="<?php _e('Enter title here'); ?>" style="font-style: italic;">for your business.</h2>
       </div>


        <div class="mw-layout-new-1-single-plan">
            <img loading="lazy" class="mw-layouts-new-1-plan-image"  src="<?php print template_url(); ?>assets/img/layouts/product-1.jpg"/>
            ...
            <div class="mw-layout-new-1-single-plan-contents">
                <div class="mw-layout-new-1-price-terms">
                    ...
                    <div data-mwplaceholder="<?php _e('Enter text here'); ?>" class="small-text muted">Prices in USD, billed annually.</div>
                </div>
                <div data-mwplaceholder="<?php _e('Enter text here'); ?>" class="mw-layout-new-1-large-text mw-layout-new-1-single-plan-description">Comprehensive legal tools for growing enterprises.</div>
