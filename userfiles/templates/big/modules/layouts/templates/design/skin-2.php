...
<section class="<?php print $layout_classes; ?> section mw-new-layouts-2">
    <module type="background" id="background-layout--<?php print $params['id'] ?>"/>
    <module type="spacer" id="spacer-layout--<?php print $params['id'] ?>-top"/>

    <div class="container mw-layout-container no-element   text-center edit safe-mode no-typing"
         field="layout-new-layouts-skin-2-<?php print $params['id'] ?>" rel="module">
        <div class="row">
            <div class="d-flex align-items-center justify-content-between mb-5">
                <h3 data-mwplaceholder="<?php _e('Enter title here'); ?>" class="mw-new-2-title">We build experience</h3>

                <div  data-mwplaceholder="<?php _e('Enter text here'); ?>" class="mw-new-2-button-text">WORK WITH US</div>

            </div>

            <div class="col-xl-4 col-sm-6 element cloneable mb-3">

                <div class="mw-layout-new-2-box background-color-element element "
                    ...
                    <div class="mw-new-2-box-padding">
                        <h4 data-mwplaceholder="<?php _e('Enter title here'); ?>" class="mw-new-2-inside-title">Prototyping</h4>
                        <p data-mwplaceholder="<?php _e('Enter text here'); ?>" >Make sure you're building the right product.</p>
                        <div class="mt-4">
