...
<section class="section py-0 d-flex align-items-center justify-content-center">
    ...
    <div class="mw-layout-container py-4 container-fluid mw-header-section-mh-100vh d-flex align-items-center justify-content-center no-element edit no-select" field="layout-header-skin-6-<?php print $params['id'] ?>" rel="module">
