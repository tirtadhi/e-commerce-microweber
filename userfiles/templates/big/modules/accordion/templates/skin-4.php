...
<div class="accordion background-color-element element" id="mw-accordion-module-<?php print $params['id'] ?>">
    <?php foreach ($json
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="header-item-<?php print $edit_field_key ?>">
                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapse-accordion-item-<?php print $edit_field_key . '-' . $key ?>"
                        aria-expanded="true"
                        aria-controls="collapse-accordion-item-<?php print $edit_field_key . '-' . $key ?>">
                    <?php print isset($slide['icon']) ? $slide['icon'] . ' ' : ''; ?><?php print isset($slide['title']) ? $slide['title'] : ''; ?>
                </button>
            </h2>

            <div id="collapse-accordion-item-<?php print $edit_field_key . '-' . $key ?>"
