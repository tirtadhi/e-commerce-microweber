...
class LiveEditTemplateSettingsSidebar extends AdminComponent
{
    ...
    public function getSettings()
    {
        ...
        $dirName = $getTemplateConfig['dir_name'] ?? template_name() ?? 'default';

        $optionGroup = 'mw-template-' . $dirName . '-settings';
        $optionGroupLess = 'mw-template-' . $dirName;

        $options = [];
        $settingGroups = [];

        if (isset($getTemplateConfig['stylesheet_compiler']['settings']) && is_array($getTemplateConfig['stylesheet_compiler']['settings'])) {
        ...
        if (isset($getTemplateConfig['template_settings']) && is_array($getTemplateConfig['template_settings'])) {
            $valuesGroup = 'Other';
